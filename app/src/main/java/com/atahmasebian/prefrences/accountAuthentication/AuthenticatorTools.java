...
class AuthenticatorTools extends AbstractAccountAuthenticator {
    ...
    public AuthenticatorTools(Context context) {
        super(context);
    ...
    public String getAuthTokenLabel(String authTokenType) {
        if (AUTHTOKEN_TYPE_FULL_ACCESS.equals(authTokenType))
            return AccountGeneralTag.AUTHTOKEN_TYPE_FULL_ACCESS_LABEL;
        else if (AUTHTOKEN_TYPE_READ_ONLY.equals(authTokenType))
            return AccountGeneralTag.AUTHTOKEN_TYPE_READ_ONLY_LABEL;
        else
